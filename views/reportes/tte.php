...
$('#print').click(function(){
	left=1;
	top=1;
	var s=window.showModalDialog("main.php?controller=reportes&action=imprimirTTE","","center:0;dialogWidth:10px;dialogHeight:10px;scroll=no;resizable=no;status=no;"+"dialogLeft:0px;dialogTop:0px");	  
});
$('#vista').click(function(){
	...
	top=(top-700)/2;
	var idc=$("#idc").val();
	var s=window.showModalDialog("main.php?controller=reportes&action=viewTTE","","center:0;dialogWidth:1000px;dialogHeight:700px;scroll=yes;resizable=yes;status=yes;"+"dialogLeft:"+left+"px;dialogTop:"+top+"px");	  
});
	});
	</script>
<style type="text/css">
...
<tr><td><?php echo $n; ?></td><td><?php echo $q->nombre; ?></td><td><?php echo $q->tte; ?></td></tr>
<?php	
$n++;
} ?>
</tbody>
