...
<!-- titulo-->
<div class="ui-widget">
<div class="ui-widget-header ui-corner-top"><h3><span style="color: #666;">CADETES: </span>Lista de Cadetes Gesti&oacute;n. <?php echo $_SESSION['gestion'];?></h3></div>
            ...
            for (var i = 0, l = rows.length; i < l; i++) {
				...
				*/
				...
				$("#formulario #nombres").val(dataView.rows[idc].name);
                                $("#formulario #idCadete").val(dataView.rows[idc].id);
				$('#fotografia').attr('src','views/fotografias/'+dataView.rows[idc].foto);
				$("#foto").attr('value','CAMBIAR')
...
$('#dialog-link')
			...
			.click(function() {
				...
				$("#fotografia").attr('src','views/fotografias/sinFoto.jpg');
				$("#foto").attr('value','SUBIR FOTO');
...
$('#foto').click(function(){
	...
	top=(top-500)/2;
	var idc=$("#idc").val();
	var r=window.showModalDialog("views/upload.php","","center:0;dialogWidth:700px;dialogHeight:500px;scroll=yes;resizable=yes;status=yes;"+"dialogLeft:"+left+"px;dialogTop:"+top+"px");

	$('#fotografia').attr('src',r[0]);
});
...
$('#importar').click(function(){
	...
	top=(top-700)/2;
	var idc=$("#idc").val();
	var s=window.showModalDialog("main.php?controller=cadete&action=importarCadetes&idc="+idc,"","center:0;dialogWidth:1000px;dialogHeight:700px;scroll=yes;resizable=yes;status=yes;"+"dialogLeft:"+left+"px;dialogTop:"+top+"px");	  
});
...
<option value="1" class="1">PRIMER</option>
<option value="2" class="2">SEGUNDO</option>
...
<P>
<label><input type="button" id="foto" name="foto" value="fotografia"/></label>
<img src="" name="fotografia" width="100" height="110" id="fotografia" style="border:1px solid #333;" />
</P>
