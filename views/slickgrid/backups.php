...
<script>
		...
		var idCadete2;
		var columns = [
			{id:"id", name:"#", field:"id", behavior:"select", cssClass:"cell-selection", width:40, cannotTriggerInsert:true, resizable:false, unselectable:true },
			{id:"name", name:"Materno", field:"name", width:150 , minWidth:120, cssClass:"cell-title", validator:requiredFieldValidator, sortable:true},
			{id:"extension", name:"Nombres", field:"extension", width:20 , minWidth:120, cssClass:"cell-title", validator:requiredFieldValidator, sortable:true},			
			{id:"fecha", name:"Fecha de Creacion", field:"fecha", width:40 , minWidth:120, cssClass:"cell-title", validator:requiredFieldValidator, sortable:true},
			{id:"size", name:"Curso", field:"size", width:40, resizable:true,  sortable:true}
		];
		...
		$(function()
		{
			...
			$.getJSON("main.php?controller=admin&action=listar_backups_json", function(dat){									
				$.each(dat, function(i,item){
				    d = (data[i] = {});					
					d["id"] = i;	                
					d["name"] = item.nombre;
					d["fecha"]=item.fecha;
					d["extension"] = item.extension;
					d["size"] = item.size;					
				  });
...
<div id="selec">
<button id="dialog-link">Nuevo Backup</button>
