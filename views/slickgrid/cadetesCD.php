...
<!-- titulo-->
<div class="ui-widget">
<div class="ui-widget-header ui-corner-top"><h3><span style="color: #333; font-size:14px;">CADETES EN CONSEJO DISCIPLINARIO: </span>Gesti&oacute;n <?php echo $_SESSION['semestre'].'/'.$_SESSION['gestion'];?></h3></div>
<div class="options-panel" style="width: 250px;"><b>Buscar: </b><input type=text id="txtSearch" style="width: 200px;"></div>
</div>
<div style="width: 100%; float: left;" >
<div class="ui-widget-header" style="width: 100%">Listado de CadetesXX:
...
<script>
		...
		$(function()
		{
			...
			$.getJSON("main.php?controller=cadete&action=listaConsejo_json", function(dat){									
...
<div id="selec">
<button id="link">Fijar Castigo</button>
<button id="baja">Dar de Baja</button>
<button id="expu">Expulsar</button>
<button id="alta">Anular Falta</button>
