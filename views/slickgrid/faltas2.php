...
<!-- titulo-->
<div class="ui-widget">
<div class="ui-widget-header ui-corner-top"><h3><span style="color: #666;">FALTAS: </span>Lista de Faltas.</h3></div>
...
<script>
	...
	$("#editar").click(function(){
	  ...
	  var idx=[];
				...
				var val= new Array();
				var falta=dataView.rows[idc].name;
				val[1]=dataView.rows[idc].id;
				val[2]=dataView.rows[idc].pd;
				var Clase=dataView.rows[idc].clase;
				...
				$("#falta").val(falta);	
				$("#dialog-form").attr("title", "Editar Falta");							 
...
//haber
$(".boton").button();
//formulariop modal para nueva falta
$("#dialog-form").dialog({
			autoOpen: false,
			height: 220,
			width: 350,
			...
			buttons: {
				'Guardar Falta': function() {
					...
					if (bValid) {
						...
						/*$('#users tbody').before('<tr>' +
							'<td>' + gestion.val() + '</td>' + 
							'<td>' + presupuesto.val() + '</td>' + 
							'<td>' + base.val() + '</td>' + 
							'<td>' + meta.val() + '</td>' +
							'</tr>'); 
						 */						
...
<div id="selec">
<button id="dialog-link">Nueva Falta</button>
<button id="editar">Editar Falta</button>
<button id="eliminar">Eliminar Falta</button>
</div>
<div class="demo">
<div id="dialog-form" title="REGISTRO DE NUEVAS FALTAS">
<form>
<label>Clase:</label><br>
<select name="clase" id="clase" class="text ui-widget-content ui-corner-all"style="width:100%;" >
<option value="3">B1</option>
<option value="4">B2</option>
<option value="5">B3</option>
<option value="6">B4</option>
<option value="7">B5</option>
<option value="8">B6</option>
<option value="9">B7</option>
<option value="10">B8</option>
<option value="11">B9</option>
<option value="12">B10</option>
<option value="13">B11</option>
<option value="14">B12</option>
<option value="15">B13</option>
<option value="2">A</option>
<option value="1">A*</option>
</select><br>
<label>Falta</label><br>
<textarea id="falta" rows="3" class="text ui-widget-content ui-corner-all" style="width:100%;" ></textarea>
</form>

</div>
</div>        
<div id="dialog-confirm" title="Eliminar una Falta?">
...
Por favor seleccione una falta, para poder realizar la siguiente acción
	</p>
</div>        
</body>
</html>
